...
int main()
{
	...
	do
	{
		...
		case 1: {
			...
			cout << "Количество положительных элементов: " << foundpositive << endl;
			cout << "Количество отрицательных элементов: " << foundnegative << endl;
			cout << "Количество нулевых элементов: " << foundzero << endl;
			break;
		}
			  // работа со строкой
		case 2: {
